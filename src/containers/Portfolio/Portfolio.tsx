        ...
        <div className="project">
          ...
          <div className="project-text">
            ...
            <p className="description">
              ...
              simple. The app is a minimal, cross-platform vehicle for fast,
              easy connections everywhere and anywhere. It generates rooms in
              real time as-necessary in order to streamline the video meeting
              experience. I worked as the front-end design lead in a team of
              three volunteers, and implemented a React framework in Typescript,
              as well as supporting the back-end team with deployment using
              Heroku and Docker.
            </p>
          </div>
        </div>
